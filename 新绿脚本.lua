...
CoreGui:SetCore("SendNotification", {
    Title = "启动成功",
    Text = "您好"..game.Players.LocalPlayer.Name.."，欢迎使用绿·自制脚本",
    Duration = 5,
})
...
local Window = OrionLib:MakeWindow({Name = "绿·自制脚本", HidePremium = false, SaveConfig = true,IntroText = "绿.自制脚本", ConfigFolder = "好闲"})
...
Tab:AddParagraph("你好"..game.Players.LocalPlayer.Name..",欢迎使用绿·自制脚本","脚本仅供娱乐")
...
Tab:AddButton({
	Name = "绿忍者传奇",
	Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/hjjjjjjjiiugghhhhhhggyi/5555222/main/%E7%BB%BF%E8%84%9A%E6%9C%AC%20%E5%BF%8D%E8%80%85.lua", true))()
  	end
})
...
Tab:AddButton({
	Name = "绿doors",
	Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/hjjjjjjjiiugghhhhhhggyi/5555222/main/%E7%BB%BFdoors2.lua", true))()
  	end
})
...
Tab:AddButton({
	Name = "绿doors召唤怪",
	Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/hjjjjjjjiiugghhhhhhggyi/5555222/main/%E7%BB%BF%E8%84%9A%E6%9C%AC%20doors1.lua", true))()
  	end
})
Tab:AddButton({
	Name = "目前最像白的伐木脚本",
