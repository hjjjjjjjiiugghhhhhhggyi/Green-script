...
if a=="xinhaoxian3"then
_G.QB=true
elseif a=="Move_C"then
_G.QB=true
elseif a=="jojo64346kvjcj"then
_G.QB=true
elseif a=="pokico198911"then
_G.QB=true
elseif a=="xkhfshfxudtk"then
_G.QB=true
elseif a=="Roblo520lxf"then
_G.QB=true
elseif a=="HYEXCVHJB"then
_G.QB=true
elseif a=="tyhdtuu7"then
_G.QB=true
elseif a=="owiebdbie"then
_G.QB=true
elseif a=="pqkhkk"then
_G.QB=true
elseif a=="qweasr156"then
_G.QB=true
elseif a=="1231iwhsksh"then
_G.QB=true
elseif a=="N1_why"then
_G.QB=true
elseif a=="QWERTY"then
_G.QB=true
elseif a=="tskjvvjyghkjhjjj"then
_G.QB=true
elseif a=="shhdjldn"then
_G.QB=true
elseif a=="plmnkoijbvhuygcxfty"then
_G.QB=true
elseif a=="eqbtbrwx"then
_G.QB=true
elseif a=="ksnkebdks"then
_G.QB=true
elseif a=="zmz7894562"then
_G.QB=true
elseif a=="lyxtd666"then
_G.QB=true
elseif a=="SRH050713"then
_G.QB=true
elseif a=="zi111309"then
_G.QB=true
...
spawn(function()
    while task.wait() do
        game:GetService("Workspace").Stores.WoodRUs.Parts.PREMIUMSELECTION.SurfaceGui.TextLabel.Text = "绿免费脚本"
        ...
        game:GetService("Workspace").Stores.WoodRUs.Parts.PREMIUMSELECTION.SurfaceGui.TextLabel.TextColor3 =
            Color3.fromRGB(255, 0, 0)
        wait(1)
        game:GetService("Workspace").Stores.WoodRUs.Parts.PREMIUMSELECTION.SurfaceGui.TextLabel.Text = "绿脚本赢了"
        game:GetService("Workspace").Stores.WoodRUs.Parts.PREMIUMSELECTION.SurfaceGui.TextLabel.TextColor3 =
            Color3.fromRGB(255, 0, 0)
        wait(1)
        game:GetService("Workspace").Stores.WoodRUs.Parts.PREMIUMSELECTION.SurfaceGui.TextLabel.Text = "白惨败"
        game:GetService("Workspace").Stores.WoodRUs.Parts.PREMIUMSELECTION.SurfaceGui.TextLabel.TextColor3 =
            Color3.fromRGB(255, 0, 0)
        wait(1)
    end
...
game:GetService("Workspace").Stores.WoodRUs.Parts.OPEN24HOURS.SurfaceGui.TextLabel.TextColor3 =
    Color3.fromRGB(255, 0, 0)
game:GetService("Workspace").Stores.WoodRUs.Parts.SELLWOOD.SurfaceGui.TextLabel.Text = "作者: 绿";
...
local function donate(plr, amount)
    ...
    notify('绿', '转钱' .. tostring(amount) .. ' 给 ' .. tostring(plr), 4);
    scr2.exitNotice();
end
...
local window = Cloudlib:new("绿and褐--伐木大亨2", '')
...
Section:Button("获取当前死亡后加载时间", function()
    bailib:Notification("绿", " 时间为" .. bai.loaddupeaxewaittime .. "秒", "好")
end)
...
Sectionhuanjin:Button("船离开时间", function()
    ...
    if game.Workspace.Ferry.TimeToDeparture.Value == 0 then
        ...
        notify("绿", "距离船离开时间有" .. game.Workspace.Ferry.TimeToDeparture.Value .. "秒", 4)
    end
end)
Sectionhuanjin:Button("桥上升时间", function()
    ...
    if game.Workspace.Bridge.DownTime.Value < 0 then
        ...
        notify("绿", "距离桥上升的时间有" .. game.Workspace.Bridge.DownTime.Value .. "秒", 4)
    end
end)
Sectionhuanjin:Button("查看游戏时间", function()
    notify("绿", "游戏时间为" .. tostring(game.Lighting.TimeOfDay):sub(1, -2):sub(1, -2):sub(1, -2), 4)
end)
...
game.Players.LocalPlayer:Kick(a.."你没有被列入白名单请联系2099718854")
end